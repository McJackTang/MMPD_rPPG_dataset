...
_C.SIGNAL.DATA = CN()
_C.SIGNAL.DATA.INFO = CN()
_C.SIGNAL.DATA.INFO.LIGHT = ['']
_C.SIGNAL.DATA.INFO.MOTION = ['']
_C.SIGNAL.DATA.INFO.EXERCISE = [True]
_C.SIGNAL.DATA.INFO.SKIN_COLOR = [1]
_C.SIGNAL.DATA.INFO.GENDER = ['']
_C.SIGNAL.DATA.INFO.GLASSER = [True]
_C.SIGNAL.DATA.INFO.HAIR_COVER = [True]
_C.SIGNAL.DATA.INFO.MAKEUP = [True]
_C.SIGNAL.DATA.FS = 0
